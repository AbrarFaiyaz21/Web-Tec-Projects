...
<?php 
	...
	if ($arr1 === NULL) {
			...
			echo "<tbody>";
				...
				echo "<td style='text-align:center'>" . $arr1[0]->foodName . "+" . $arr1[6]->foodName . "+" . $arr1[9]->foodName . "</td>";
				echo "<td style='text-align:center'>" . 5 . "%" . "</td>";
				echo "<td style='text-align:center'>" . (int)(($arr1[0]->foodPrice)+($arr1[6]->foodPrice)+($arr1[9]->foodPrice)-(((($arr1[0]->foodPrice)+($arr1[6]->foodPrice)+($arr1[9]->foodPrice))*5)/100)) . "</td>";
				...
				echo "<td style='text-align:center'>" . $arr1[1]->foodName . "+" . $arr1[2]->foodName . "+" . $arr1[9]->foodName . "</td>";
				echo "<td style='text-align:center'>" . 5 . "%" . "</td>";
				echo "<td style='text-align:center'>" . (int)(($arr1[1]->foodPrice)+($arr1[2]->foodPrice)+($arr1[9]->foodPrice)-(((($arr1[1]->foodPrice)+($arr1[2]->foodPrice)+($arr1[9]->foodPrice))*5)/100)) . "</td>";
				...
				echo "<td style='text-align:center'>" . $arr1[5]->foodName . "+" . $arr1[6]->foodName . "+" . $arr1[8]->foodName . "</td>";
				echo "<td style='text-align:center'>" . 5 . "%" . "</td>";
				echo "<td style='text-align:center'>" . (int)(($arr1[5]->foodPrice)+($arr1[6]->foodPrice)+($arr1[8]->foodPrice)-(((($arr1[5]->foodPrice)+($arr1[6]->foodPrice)+($arr1[8]->foodPrice))*5)/100)) . "</td>";
				...
				echo "<td>" . "<a href='../controller/FoodMenuAction.php?id=" . $arr1[6]->item_id . "'>Add to Chart</a>" . "</td>";
				echo "</tr>";*/
				...
				echo "<td>" . "<a href='../controller/FoodMenuAction.php?id=" . $arr1[1]->item_id . "'>Add to Chart</a>" . "</td>";
				echo "</tr>";
				...
				echo "<td>" . "<a href='../controller/FoodMenuAction.php?id=" . $arr1[2]->item_id . "'>Add to Chart</a>" . "</td>";
				echo "</tr>";
				...
				echo "<td>" . "<a href='../controller/FoodMenuAction.php?id=" . $arr1[3]->item_id . "'>Add to Chart</a>" . "</td>";
				echo "</tr>";
				...
				echo "<td>" . "<a href='../controller/FoodMenuAction.php?id=" . $arr1[4]->item_id . "'>Add to Chart</a>" . "</td>";
				echo "</tr>";
				...
				echo "<td>" . "<a href='../controller/FoodMenuAction.php?id=" . $arr1[5]->item_id . "'>Add to Chart</a>" . "</td>";
				echo "</tr>";
				...
				echo "<td>" . "<a href='../controller/FoodMenuAction.php?id=" . $arr1[7]->item_id . "'>Add to Chart</a>" . "</td>";
				echo "</tr>";
				...
				echo "<td>" . "<a href='../controller/FoodMenuAction.php?id=" . $arr1[8]->item_id . "'>Add to Chart</a>" . "</td>";
				echo "</tr>";
				...
				echo "<td>" . "<a href='../controller/FoodMenuAction.php?id=" . $arr1[9]->item_id . "'>Add to Chart</a>" . "</td>";
				echo "</tr>";*/
